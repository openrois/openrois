...
- Renamed `BusAdapter` to `ComponentContract` and `BusAdapterError` to `ComponentContractError`, matching the Python source of truth and the paper. The old names remain as deprecated aliases for one alpha release.
